        ...
        <table class="border-collapse border border-white w-full">
            ...
            <tbody>
                ...
                <tr class="bg-gray-200 hover:bg-gray-300 border-[2px] border-black">
                    ...
                    <td class="px-4 py-2 border-[2px] border-black">{{$item->number}}</td>
