<div>
    ...
    @extends('layout.page')
    @section('content')
    <form action="/orders/create" method="POST" class="bg-amber-700  h-screen flex flex-col items-center justify-center py-12 px-6 rounded-lg shadow-md" method='post'>
        @csrf
